	...
	return (
		<div className='flex flex-col justify-center items-center w-full h-fit z-10'>
			...
			<div className='flex flex-row justify-center items-center w-fit h-full py-12 space-x-12 px-12 '>
				...
				<div className='flex flex-col justify-center items-center w-full h-full space-y-8 bg-blue-600 py-10 px-10 rounded-lg bg-opacity-90 shadow-green-400 shadow-2xl '>
					<img className='w-72 h-72' src={formData.logo.imageUrl} />
					<input
						onChange={onChangePhoto}
						className='w-fit placeholder-gray-600 border rounded-lg font-semibold text-center px-8 py-4  text-black focus:outline-green-500 focus:outline-4 shadow-black shadow-md focus:scale-125 bg-gray-400 hover:bg-white focus:transition-all ease-in-out'
						type='file'
					...
					<button
						...
						className='w-72 h-10  placeholder-gray-600 border rounded-lg font-semibold text-white focus:shadow-outline hover:bg-white hover:text-black hover:font-bold shadow-lg shadow-white hover:shadow-black'
						type='submit'
					>
						Submit
					</button>
